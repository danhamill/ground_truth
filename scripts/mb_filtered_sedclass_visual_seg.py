...
if __name__ == '__main':
    ...
    files = glob.glob(r'C:\workspace\gound_truth\input\med_filter\*.tif')
    ...
    for thing in files:
        ...
        plt.tight_layout()
        plt.show()
        plt.savefig(root + os.sep + 'mb_5_Class_filt_' + str(meter) +'_sq_meters_lowres.png',dpi=200)
        ...
        plt.tight_layout()
        plt.savefig(root + os.sep + 'mb_5_Class_filt_' + str(meter) +'_sq_meters_distributions.png')
